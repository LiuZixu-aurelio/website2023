...
var _=(a,e,t)=>e in a?L(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,v=(a,e)=>{for(var t in e||(e={}))I.call(e,t)&&_(a,t,e[t]);if(w)for(var t of w(e))M.call(e,t)&&_(a,t,e[t]);return a};import{E,l as z,g as n,a as i,C as g,W as p,S as f,P as x,b as k,c as y,V as h,M as u,T,R as j,i as R,G as D,d as P,e as c,A as b,f as O,D as U,h as q,j as H,k as A}from"./vendor.513b68c2.js";const B=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);
new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerpolicy&&(s.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?s.credentials="include":r.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(r){if(r.ep)return;r.ep=!0;
const s=t(r);fetch(r.href,s)}};
B();
class d extends E{
        constructor({element:e,elements:t}){
            super();
            this.selector=e,this.selectorChildren=v({},t),
            this.create(),
    ...
    create(){
        ...
        this.elements={},
        z.exports.each(this.selectorChildren,
        (e,t)=>
            {
                e instanceof window.HTMLElement||e instanceof window.NodeList||Array.isArray(e)?this.elements[t]=e:(
                    this.elements[t]=document.querySelectorAll(e),this.elements[t].length===0?this.elements[t]=null:this.elements[t].length===1&&(
...
class G extends d{constructor(){
        super({componentId:"Preloader",element:".l__preloader",elements:{subline:".preloader__subline"}});
        this.isDesktop=window.innerWidth>1024,this.allImages=document.querySelectorAll("img"),
        this.createLoader()
    }
    createLoader(){window.addEventListener("load",()=>{this.onLoaded()})}
    onLoaded(){
        return new Promise(e=>{this.emit("completed");const t=n.timeline();
        this.isDesktop?(t.to(".preloader__roll",{opacity:0,duration:1,ease:i.easeOut},"out"),t.to(this.element,{xPercent:-100,ease:i.easeInOut,duration:1.5},"out+=0.5"),t.to(this.elements.subline,{xPercent:-100,ease:i.easeInOut,duration:1.6},"out+=0.55"),n.to(".preloader__blackline",{xPercent:-100,delay:.05,duration:1.6,ease:i.easeInOut},"")):(t.to(this.element,{yPercent:-100,ease:i.easeInOut,duration:1.5},"out+=0.5"),t.to(this.elements.subline,{yPercent:-100,ease:i.easeInOut,duration:1.6},"out+=0.55"),n.to(".preloader__blackline",{yPercent:-100,delay:.05,duration:1.6,ease:i.easeInOut},""))})
    }
}
class S{constructor({element:e,elements:t,id:o}){this.selector=e,this.selectorChildren=v({},t),this.id=o}create(){this.element=document.querySelector(this.selector),this.elements={},z.exports.each(this.selectorChildren,(e,t)=>{e instanceof window.HTMLElement||e instanceof window.NodeList||Array.isArray(e)?this.elements[t]=e:this.elements[t]=document.querySelectorAll(e),this.elements[t].length===0?this.elements[t]:this.elements[t].length===1&&(this.elements[t]=document.querySelector(e))})}}
class C extends d{constructor(e,t){
    super({
        componentId:"navbar",
        element:".l__navbar",
        elements:{navbarLink:".l__navbar .menu-item",
    ...
    this.elements.navbarLink&&(
        this.sectionsPosition=[document.querySelector(".l__projects").getBoundingClientRect().left,document.querySelector(".l__about").getBoundingClientRect().left+window.innerHeight,document.querySelector(".l__contact").getBoundingClientRect().left+window.innerHeight],this.initClick()
    ),
    this.initLogoClick()
}
initClick(){
    this.elements.navbarLink.forEach(
        (e,t)=>{e.addEventListener("click",o=>{o.preventDefault();let r=0;t===0&&(r=this.sectionsPosition[0]),t===1&&(r=this.sectionsPosition[1]+document.querySelector(".pin-spacer").offsetHeight),t===2&&(r=2e4),this.asscroll.scrollTo(r)})}
    )
}
initLogoClick(){
    this.elements.navbarLogo.addEventListener("click",e=>{
        e.preventDefault(),window.innerWidth>1024?(n.to(".preloader__subline",{
            xPercent:0,duration:1.5,ease:i.easeInOut
        }),n.to(".preloader__blackline",{
            xPercent:0,delay:.05,duration:1.6,ease:i.easeInOut,onComplete:()=>window.location.href="/1.html"
        })):(n.to(".preloader__subline",{
            yPercent:0,duration:1.5,ease:i.easeInOut,onComplete:()=>window.location.href="/1.html"
        }),n.to(".preloader__blackline",{
            yPercent:0,delay:.05,duration:1.6,ease:i.easeInOut,onComplete:()=>window.location.href="/1.html"
        }))
    }),
    this.elements.hamburgah&&(this.elements.hamburgah.addEventListener("click",e=>{
        e.preventDefault(),n.to(".preloader__subline",{
            yPercent:100,duration:1.5,ease:i.easeInOut
        }),n.to(this.elements.mobileMenu,{y:"0%",duration:1.5,ease:i.easeInOut,delay:.05})
    }),this.elements.close.addEventListener("click",e=>{
            e.preventDefault(),n.to(".preloader__subline",{
            yPercent:-100,duration:1.5,ease:i.easeInOut
        }),n.to(".preloader__blackline",{
            xPercent:-100,delay:.05,duration:1.6,ease:i.easeInOut
        }),n.to(this.elements.mobileMenu,{
            y:"-100%",duration:1.5,ease:i.easeInOut,delay:.05
        })
    }),this.elements.mobileMenuItem.forEach((e,t)=>{
            e.addEventListener("click",o=>{o.preventDefault(),n.to(".preloader__subline",{
            yPercent:-100,duration:1.5,ease:i.easeInOut
        }),
        n.to(".preloader__blackline",{xPercent:-100,delay:.05,duration:1.6,ease:i.easeInOut}),
        n.to(this.elements.mobileMenu,{
            y:"-100%",duration:1.5,ease:i.easeInOut,delay:.05,onComplete:()=>this.asscroll.scrollTo(document.querySelectorAll(".section")[t].getBoundingClientRect().top-this.navbarSize)
        }
        )})
    }))
}removeEventListeners(){}}var W=`varying vec2 vUv;
