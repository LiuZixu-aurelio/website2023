...
initLogoClick(){
    this.elements.navbarLogo.addEventListener("click",e=>{
        e.preventDefault(),window.innerWidth>1024?(n.to(".preloader__subline",{
            ...
            xPercent:0,delay:.05,duration:1.6,ease:i.easeInOut,onComplete:()=>window.location.href="/"
        })):(n.to(".preloader__subline",{
            yPercent:0,duration:1.5,ease:i.easeInOut,onComplete:()=>window.location.href="/"
        }),n.to(".preloader__blackline",{
            yPercent:0,delay:.05,duration:1.6,ease:i.easeInOut,onComplete:()=>window.location.href="/"
        }))
    }),
